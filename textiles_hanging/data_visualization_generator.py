...
try:
    ...
    models_with_name = {'HANGnet': HANGnet, 'HANGnet_dropout': HANGnet_dropout,
                        ...
                        'HANGnet_classify_regularized': HANGnet_classify_regularized,
...
def main(training_data_dir: 'folder containing training data',
         ...
         regression: 'Whether the model is for regression or classification'=True
         ):
    """
    ...
    if regression:
        ...
        params = {'batch_size': len(test_files), 'resize': True, 'shuffle': False}
    ...
    logging.info('Model is doing: {}'.format("regression" if regression else "classification"))
